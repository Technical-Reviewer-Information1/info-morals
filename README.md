...
『大学入学共通テスト「情報Ⅰ」対策問題集』（技術評論社, ISBN 978-4-297-15084-6）pp.216-217 連動Webアプリ。

**公開URL**: https://technical-reviewer-information1.github.io/info-morals/

SNSの投稿を実際に点検し、信ぴょう性の確かめ方やフィルターバブルのしくみを体験します。
